...
for ii=1:npie
    ...
    xlabel('t [s]')
    ylabel('tau [1/m]')
    auxstr  =strcat('.\last_itr\torsion',num2str(ii),'.png');
    print('-dpng',auxstr)
    ...
    xlabel('t [s]')
    ylabel('xci [1/m]')
    auxstr  =strcat('.\last_itr\\curvature',num2str(ii),'_on_y.png');
    print('-dpng',auxstr)
    ...
    xlabel('t [s]')
    ylabel('k [1/m]')
    auxstr  =strcat('.\last_itr\\curvature',num2str(ii),'_on_z.png');
    print('-dpng',auxstr)
    ...
    xlabel('t [s]')
    ylabel('q [-]')
    auxstr  =strcat('.\last_itr\\longitudinal_strain',num2str(ii),'.png');
    print('-dpng',auxstr)
    ...
    xlabel('t [s]')
    ylabel('p [-]')
    auxstr  =strcat('.\last_itr\\tras_y_strain',num2str(ii),'.png');
    print('-dpng',auxstr)
    ...
    xlabel('t [s]')
    ylabel('r [-]')
    auxstr  =strcat('.\last_itr\\tras_z_strain',num2str(ii),'.png');
    print('-dpng',auxstr)
...
mov               =VideoWriter(strcat('.\last_itr\SectionDynamics'),'MPEG-4');
