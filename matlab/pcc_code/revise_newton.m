function [xi_star, err, k] = revise_newton(L1, L2, L3, q, r, xi, mstep, tol, type)
%REVISE_NEWTON Correct the initial value with the Newton-Raphson method.
...
if isequal(type, 'plot')
    revise_plot(0: k, omg_e(1:k+1), v_e(1:k+1), e(1: k+1), tol, 3);
end
end