...
plt.title("Simple arch", fontdict={"size": 23, 'weight': "bold"})
...
plt.plot(test_set_1[:, 0], test_set_1[:, 1])
plt.plot(test[:, 0], test[:, 1], 'ro:')
plt.title("Simple wave", fontdict={"size": 23, 'weight': "bold"})
...
plt.title("Plushy heart", fontdict={"size": 23, 'weight': "bold"})
...
plt.title("Ten-point Bezier Curve", fontdict={"size": 23, 'weight': "bold"})
