...
class Plotter3D:
    def __init__(self, fig, num_plots=1, rows=None, cols=None):
        if cols is None:
        ...
        self._axarr  = [plt.subplot(self._gs[0], projection='3d') for i in range(num_plots)]
    ...
    def plot(self, i, xs, ys, zs, linestyle='-', linewidth=2.5, marker=None,
    ...
    def plot_3d_points(self, i, points, linestyle='-', linewidth=2.0,
            marker=None, markersize=5.0, markeredgewidth=1.0, color='m',
            alpha=1.0, label=''):
        self.plot(i, points, points, points,
